...
const companies = [
  ['Goldman Sachs', 'GS', 'Internal Audit · Software Engineering'],
  ['JPMorgan Chase & Co.', 'JPM', 'Software Engineering'],
  ['Bank of America', 'BofA', 'Investment Banking'],
  ['Microsoft', 'MS', 'Azure · Data Engineering'],
  ['Google', 'G', 'Project Management · Data'],
...
function CompanyLogo({ mark, name }) {
